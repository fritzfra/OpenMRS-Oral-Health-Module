 ...
 * "oralhealthmodule.title" heading. 
 */
public class AdminList extends AdministrationSectionExt {
	...
	public Map<String, String> getLinks() {
		...
		map.put("/module/oralhealthmodule/manage.form", "oralhealthmodule.manage");	
		map.put("/module/oralhealthmodule/addOralHealth.form", "oralhealthmodule.addOralHealth");
		map.put("/module/oralhealthmodule/oralHealthList.form", "oralhealthmodule.oralHealthList");
		return map;
	}
	/**
    public Map<String, String> getLinks() {

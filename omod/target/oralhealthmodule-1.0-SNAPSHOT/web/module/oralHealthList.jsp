...
<div class="box">
	<table cellpadding="2" cellspacing="0" id="oralHealth" width="98%">
		<tr>
			...
			<th title="The DMFT Index is a sum of all teeth that are either decayed, missing or filled."> <spring:message code="oralhealthmodule.dmft"/> </th>
